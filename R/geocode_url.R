...
#' @param dryrun logical; when \code{TRUE}, aborts script prior to the \code{\link{pull_geo_data}} function, returning the URL to be encoded. This can be useful for debugging addresses that yield non-conformant JSON returns.
...
#'   \item \strong{locations:} character; the user supplied values in the \code{address} parameter (for matching/verification).
